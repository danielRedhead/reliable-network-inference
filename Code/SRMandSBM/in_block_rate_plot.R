...
recov_res_true_m[,2] <- rep(out_block_in_block, PP)
recov_res_true_m[,3] <- rep(dr_sigma_in_block, PP)
recov_res_true_m[,4] <- rep(dr_rho_in_block, PP)
recov_res_true_m[,5] <- rep(sr_sigma_in_block[1], PP)
recov_res_true_m[,6] <- rep(sr_sigma_in_block[2], PP)
recov_res_true_m[,7] <- rep(sr_rho_in_block, PP)
