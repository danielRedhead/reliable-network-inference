...
recov_res_true_m[,1] <- rep(in_block_dr_sigma, PP)
recov_res_true_m[,2] <- rep(out_block_dr_sigma, PP)
recov_res_true_m[,3] <- DR_sigma_test
recov_res_true_m[,4] <- rep(dr_rho_dr_sigma, PP)
recov_res_true_m[,5] <- rep(sr_sigma_dr_sigma[1], PP)
recov_res_true_m[,6] <- rep(sr_sigma_dr_sigma[2], PP)
recov_res_true_m[,7] <- rep(sr_rho_dr_sigma, PP)
