...
recov_res_true_m[,1] <- rep(in_block_sr_rho, PP)
recov_res_true_m[,2] <- rep(out_block_sr_rho, PP)
recov_res_true_m[,3] <- rep(dr_sigma_sr_rho, PP)
recov_res_true_m[,4] <- rep(dr_rho_sr_rho, PP)
recov_res_true_m[,5] <- rep(sr_sigma_sr_rho[1], PP)
recov_res_true_m[,6] <- rep(sr_sigma_sr_rho[2], PP)
recov_res_true_m[,7] <- SR_rho_test
