...
G = simulate_srm_network(N_id = N_id_dr_rho, 
                         B = B_dr_rho, 
                         sr_mu = sr_mu_dr_rho,  
...
model_dat = make_strand_data(self_report=list(G$network),  group_ids=NULL, individual_covariates=data.frame(Status=predictor_1_dr_rho), dyadic_covariates=NULL)
