...
recov_res_true_m[,1] <- rep(B_dr_rho, PP)
recov_res_true_m[,2] <- rep(dr_sigma_dr_rho, PP)
recov_res_true_m[,3] <- DR_rho_test
recov_res_true_m[,4] <- rep(sr_sigma_dr_rho[1], PP)
recov_res_true_m[,5] <- rep(sr_sigma_dr_rho[2], PP)
recov_res_true_m[,6] <- rep(sr_rho_dr_rho, PP)
