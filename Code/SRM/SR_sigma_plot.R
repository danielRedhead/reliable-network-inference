...
recov_res_true_m[,1] <- rep(B_sr_sigma, PP)
recov_res_true_m[,2] <- rep(dr_sigma_sr_sigma, PP)
recov_res_true_m[,3] <- rep(dr_rho_sr_sigma, PP)
recov_res_true_m[,4] <- 1.7*SR_sigma_test
recov_res_true_m[,5] <- SR_sigma_test
recov_res_true_m[,6] <- rep(sr_rho_sr_sigma, PP)
