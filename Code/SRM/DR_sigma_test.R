...
G = simulate_srm_network(N_id = N_id_dr_sigma, 
                         B = B_dr_sigma, 
...
model_dat = make_strand_data(self_report=list(G$network),  group_ids=NULL, individual_covariates=data.frame(Status=predictor_1_dr_sigma), dyadic_covariates=NULL)
