...
G = simulate_srm_network(N_id = N_id_sr_predictor, 
                         B = B_sr_predictor, 
...
model_dat = make_strand_data(self_report=list(G$network),  group_ids=NULL, individual_covariates=data.frame(Status=predictor_1_sr_predictor), dyadic_covariates=NULL)
